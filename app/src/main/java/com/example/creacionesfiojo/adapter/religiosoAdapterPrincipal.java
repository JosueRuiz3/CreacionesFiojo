...
import com.example.creacionesfiojo.DetalleReligiosoPrincipal;
...
public class religiosoAdapterPrincipal extends FirestoreRecyclerAdapter<religioso, religiosoAdapterPrincipal.ViewHolder> {
     ...
     * @param options
     */
    public religiosoAdapterPrincipal(@NonNull FirestoreRecyclerOptions<religioso> options, Activity activity) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull religiosoAdapterPrincipal.ViewHolder holder, int position, @NonNull religioso Religioso) {
        ...
        holder.editar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(activity, DetalleReligiosoPrincipal.class);
    ...
    @NonNull
    @Override
    public religiosoAdapterPrincipal.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_religioso, parent, false);
        return new religiosoAdapterPrincipal.ViewHolder(v);
    }
