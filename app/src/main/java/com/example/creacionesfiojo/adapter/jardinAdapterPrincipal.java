...
import com.example.creacionesfiojo.JardinPrincipal;
...
public class jardinAdapterPrincipal extends FirestoreRecyclerAdapter<jardin, jardinAdapterPrincipal.ViewHolder>{
     ...
     * @param options
     */
    public jardinAdapterPrincipal(@NonNull FirestoreRecyclerOptions<jardin> options, Activity activity) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull jardinAdapterPrincipal.ViewHolder holder, int position, @NonNull jardin Jardin) {
        ...
        holder.editar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(activity, DetalleJardinPrincipal.class);
    ...
    @NonNull
    @Override
    public jardinAdapterPrincipal.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_jardin_admin, parent, false);
        return new jardinAdapterPrincipal.ViewHolder(v);
    }
