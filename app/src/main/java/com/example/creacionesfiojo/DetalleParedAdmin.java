...
public class DetalleParedAdmin extends AppCompatActivity {

    boolean valid = true;
    EditText txtnombre, txtprecio, txtdimensiones, txtmaterial;
    ImageView pared_photo, btn_eliminar, btn_habilitar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pared_admin);
        ...
        btn_habilitar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DetalleParedAdmin.this);
                ...
                builder.setMessage("¿Desea editar este producto?")
                        .setPositiveButton("SI", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                String download_uri = pared_photo.getImageMatrix().toString().trim();
                                ...
                                if (!nombre.isEmpty() && !dimensiones.isEmpty() && !material.isEmpty() && !precio.isEmpty() && !download_uri.isEmpty()) {
                                    ...
                                    Toast.makeText(DetalleParedAdmin.this, "Ingrese los datos", Toast.LENGTH_SHORT).show();
                                }
                            }
                        })
                        .setNegativeButton("NO", new DialogInterface.OnClickListener() {
                ...
                builder.setMessage("¿Desea eliminar este producto?")
                        .setPositiveButton("SI", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                delete(id);
                                finish();
                                Intent intent = new Intent(DetalleParedAdmin.this, ParedAdmin.class);
            ...
            public boolean onNavigationItemSelected(@NonNull @org.jetbrains.annotations.NotNull MenuItem item) {
                ...
                switch (id)
                {
                    case R.id.inicioA:
                        ...
                        startActivity(new Intent(DetalleParedAdmin.this, AdminActivity.class));
                        finish();
                        break;

                    case R.id.jardinA:
                        FirebaseAuth.getInstance().signOut();
                        startActivity(new Intent(DetalleParedAdmin.this, JardinAdmin.class));
                        finish();
                        break;

                    case R.id.paredA:
                        FirebaseAuth.getInstance().signOut();
                        startActivity(new Intent(DetalleParedAdmin.this, ParedAdmin.class));
                        finish();
                        break;

                    case R.id.religionA:
                        FirebaseAuth.getInstance().signOut();
                        startActivity(new Intent(DetalleParedAdmin.this, ReligiosoAdmin.class));
                        finish();
                        break;

                    case R.id.macetaA:
                        FirebaseAuth.getInstance().signOut();
                        startActivity(new Intent(DetalleParedAdmin.this, MacetaAdmin.class));
                        finish();
                        break;
                    case R.id.agregarJadrinA:
                        finish();
                        startActivity(new Intent(DetalleParedAdmin.this, AgregarFiguraJardin.class));
                        break;

                    case R.id.cerrarsesionA:
                        FirebaseAuth.getInstance().signOut();
                        startActivity(new Intent(DetalleParedAdmin.this, LoginActivity.class));
                        break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 100 && data != null && data.getData() != null) {
            ...
            pared_photo.setImageURI(imageUri);
        }
    }
    private void subirDatos(String nombre, String dimensiones, String material, String precio, String id) {
        ...
        if(imageUri!=null)     {
            ...
            StorageReference reference = storageReference.child("pared/" + UUID.randomUUID().toString());
            ...
            reference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            uriTask.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    map.put("pared", download_uri);
                                    mfirestore.collection("Ceramica-Pared").document(id).update(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void unused) {
                                            finish();
                                            Toast.makeText(DetalleParedAdmin.this, "Datos Actualizados con exito", Toast.LENGTH_SHORT).show();
                                        }
                    ...
                    .addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            progressDialog.setMessage("Cargando "+(int)progres+"%");
                        }
                    }) ;
        }
    }
    ...
    private void delete(String id) {
        mfirestore.collection("Ceramica-Pared").document(id).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Toast.makeText(DetalleParedAdmin.this, "Eliminado Correctamente", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
